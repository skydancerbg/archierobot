...
// Have in mind, that after defining USE_USBCON, 3 seconds delay is introduced by ArduinoHardware.h in order to allow for sketch upload: 
...
// Make the necessary changes (like IMU hardware type used) in:  /home/YOUR_USER_NAME/archie_ws/src/archierobot/arduino_due/firmware_due/lib/config/firmware_config.h
#include "firmware_config.h"

// Because of the limited bandwith and resources (on Arduino Due over rosserial), 
...
#include "archie_msgs/Imu.h" //// location:  /home/YOUR_USER_NAME/archie_ws/src/archierobot/arduino_due/firmware_due/lib/ros_lib/archie_msgs
#include "Imu.h"             //// location:  /home/YOUR_USER_NAME/archie_ws/src/archierobot/arduino_due/firmware_due/lib/imu
